...
const icons = [
  ...
  <Flag className="w-8 h-8 text-brand-primary" />,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="group p-8 bg-white/5 border border-white/5 rounded-sm hover:border-brand-primary/50 hover:bg-white/10 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold mb-3 font-mono text-white group-hover:text-brand-primary transition-colors">{feature.title}</h3>
