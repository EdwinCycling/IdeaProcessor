...
const HowItWorks: React.FC = () => {
  ...
  return (
    <section id="how-it-works" className="py-24 bg-exact-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="mb-16">
            <span className="text-exact-red font-mono text-sm tracking-widest uppercase mb-2 block">{TEXTS.HOW_IT_WORKS.WORKFLOW}</span>
         ...
         <div className="relative grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="relative">
                <div className="w-24 h-24 bg-exact-panel border border-white/10 rounded-full flex items-center justify-center mx-auto mb-6 shadow-[0_0_20px_rgba(0,0,0,0.5)] z-10">
            ...
            {/* Step 3 */}
            <div className="relative">
                <div className="w-24 h-24 bg-exact-panel border border-white/10 rounded-full flex items-center justify-center mx-auto mb-6 shadow-[0_0_20px_rgba(225,0,0,0.2)] z-10">
                    <Sparkles className="w-10 h-10 text-exact-red" />
                </div>
                <div className="text-center">
